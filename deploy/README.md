...
deploy/
  ...
  config/                   # Shared config files
    nginx.conf.template     # Frontend nginx with COEP/COOP headers; ${THUNDERBOLT_BACKEND_HOST}/${THUNDERBOLT_BACKEND_PORT}/${THUNDERBOLT_BACKEND_RESOLVER} substituted at container start
